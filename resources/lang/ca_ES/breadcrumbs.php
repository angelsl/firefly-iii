...
return [
    ...
    'bills'                  => 'Subscripcions',
    'newBill'                => 'Nova subscripció',
    'edit_bill'              => 'Editar subscripció ":name"',
    ...
    // mfa
    'profile_mfa'            => 'Autenticació multifactor',
    'mfa_enableMFA'          => 'Activar l\'autenticació multifactor',
    'mfa_backup_codes'       => 'Codis de seguretat',
    'mfa_disableMFA'         => 'Desactivar l\'autenticació multifactor',

    // notifications
    'notification_index'     => 'Notificacions de propietari',

    // exchange rates
    'exchange_rates_index'   => 'Tipus de canvi',
    'exchange_rates_rates'   => 'Tipus de canvi entre :from i :to (i a l\'invers)',
];
