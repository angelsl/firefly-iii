...
return [
    ...
    // bill index
    'bills_index_rules'                                       => 'Aquí pots veure quines regles s\'aplicaran si aquesta subscripció s\'aplica',
    'bills_index_paid_in_period'                              => 'Aquest camp indica quan es va pagar la subscripció per últim cop.',
    'bills_index_expected_in_period'                          => 'Aquest camp indica per cada subscripció, si i com s\'espera que arribi la pròxima subscripció.',

    'subscriptions_index_rules'                               => 'Aquí pots veure quines regles s\'aplicaran si aquesta subscripció s\'aplica',
    'subscriptions_index_paid_in_period'                      => 'Aquest camp indica quan es va pagar la subscripció per últim cop.',
    'subscriptions_index_expected_in_period'                  => 'Aquest camp indica per cada subscripció, si i com s\'espera que arribi la pròxima subscripció.',

    // show bill
    'bills_show_billInfo'                                     => 'Aquesta taula mostra informació general sobre aquesta subscripció.',
    'bills_show_billButtons'                                  => 'Fes servir aquest botó per escanejar de nou transaccions antigues per correspondre-les a aquesta subscripció.',
    'bills_show_billChart'                                    => 'Aquesta gràfica mostra les transaccions enllaçades a aquesta subscripció.',
    'subscriptions_show_billInfo'                             => 'Aquesta taula mostra informació general sobre aquesta subscripció.',
    'subscriptions_show_billButtons'                          => 'Fes servir aquest botó per escanejar de nou transaccions antigues per correspondre-les a aquesta subscripció.',
    'subscriptions_show_billChart'                            => 'Aquesta gràfica mostra les transaccions enllaçades a aquesta subscripció.',

    // create bill
    'bills_create_intro'                                      => 'Fes servir les subscripcions per fer el seguiment als diners que deguis a cada període. Pensa en despeses com el lloguer, assegurança o el pagament de la hipoteca.',
    'bills_create_name'                                       => 'Usa noms descriptius com "Lloguer" o "Assegurança de salut".',
    // 'bills_create_match'                                      => 'To match transactions, use terms from those transactions or the expense account involved. All words must match.',
    'bills_create_amount_min_holder'                          => 'Selecciona una quantitat mínima i màxima per aquesta subscripció.',
    'bills_create_repeat_freq_holder'                         => 'La majoria de subscripcions es repeteixen mensualment, però pots establir una altra freqüència aquí.',
    'bills_create_skip_holder'                                => 'Si una subscripció es repeteix cada 2 setmanes, el camp "ometre" s\'ha d\'establir a "1" per saltar cada altra setmana.',
