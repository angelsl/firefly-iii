...
return [
    ...
    'both_link_piggy'                             => 'Els comptes d\'aquesta transacció estan enllaçats a la guardiola, per la qual cosa no es durà a terme cap acció.',
    'already_linked'                              => 'Aquesta transacció ja està enllaçada a la guardiola ":name"',
    ...
    'journal_invalid_amount'                      => 'Firefly III no pot definir la quantitat ":amount" perquè no és un número vàlid.',
    'cannot_remove_zero_piggy'                    => 'No es pot treure l\'import zero de la guardiola ":name"',
    'cannot_remove_from_piggy'                    => 'Cannot remove :amount from piggy bank ":name"',
    'cannot_add_zero_piggy'                       => 'No es pot afegir una quantitat zero a la guardiola ":name"',
