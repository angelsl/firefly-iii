 ...
 */
    ...
    'disable_mfa_intro'                                           => 'Você pode desativar o segundo fator de autenticação. Para fazer isso, digite sua senha e o código do segundo fator de autenticação. Se você deseja desativar o segundo fator de autenticação porque perdeu acesso ao seu app de autenticação, <a href="https://docs.firefly-iii.org/references/faq/firefly-iii/using/#i-lost-my-2fa-token-generator-or-2fa-has-stopped-working">por favor confira a documentação ao invés disso</a>.',
    'pref_disable_mfa'                                            => 'Desativar segundo fator de autenticação',
    'mfa_not_enabled'                                             => 'Segundo fator de autenticação não está ativado.',
    'mfa_backup_codes_intro'                                      => 'O Firefly III pode gerar códigos de backup para você. Esses códigos podem ser usados para fazer login quando você não pode usar o seu gerador de código. Você pode gerar um novo conjunto de códigos a qualquer momento. Se você gerar um novo conjunto, o conjunto antigo será invalidado.',
    'mfa_backup_codes_quick'                                      => 'Se você é muito rápido vindo da página de configuração do segundo fator de autenticação, seu aplicativo pode não ter gerado um novo código ainda. Por favor, saiba que os códigos MFA só podem ser usados uma vez. Certifique-se de usar um código diferente do anterior.',
