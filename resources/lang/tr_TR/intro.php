...
return [
    ...
    'bills_index_paid_in_period'                              => 'Bu alan aboneliğin en son ne zaman ödendiğini gösterir.',
    'bills_index_expected_in_period'                          => 'Bu alan, her abonelik için bir sonraki aboneliğin ne zaman gerçekleşmesinin beklendiğini gösterir.',

    'subscriptions_index_rules'                               => 'Burada, bu aboneliğe ulaşılıp ulaşılmadığını hangi kuralların kontrol edeceğini görüyorsunuz',
    'subscriptions_index_paid_in_period'                      => 'Bu alan aboneliğin en son ne zaman ödendiğini gösterir.',
    'subscriptions_index_expected_in_period'                  => 'Bu alan, her abonelik için bir sonraki aboneliğin ne zaman gerçekleşmesinin beklendiğini göster.',

    // show bill
    'bills_show_billInfo'                                     => 'Bu tablo, bu abonelikle ilgili bazı genel bilgileri göstermektedir.',
    'bills_show_billButtons'                                  => 'Eski işlemleri bu abonelikle eşleşecek şekilde yeniden taramak için bu düğmeyi kullanın.',
    'bills_show_billChart'                                    => 'Bu grafik, bu abonelikle bağlantılı işlemleri gösterir.',
    'subscriptions_show_billInfo'                             => 'Bu tablo, bu abonelikle ilgili bazı genel bilgileri göstermektedir.',
    'subscriptions_show_billButtons'                          => 'Eski işlemleri bu abonelikle eşleşecek şekilde yeniden taramak için bu düğmeyi kullanın.',
    'subscriptions_show_billChart'                            => 'Bu grafik, bu abonelikle bağlantılı işlemleri gösterir.',

    // create bill
    'bills_create_intro'                                      => 'Her dönem ödemeniz gereken para miktarını takip etmek için abonelikleri kullanın. Kira, sigorta veya ipotek ödemeleri gibi giderleri düşünün.',
    'bills_create_name'                                       => '"Kira" veya "Sağlık sigortası" gibi açıklayıcı bir isim kullanın.',
    // 'bills_create_match'                                      => 'To match transactions, use terms from those transactions or the expense account involved. All words must match.',
    'bills_create_amount_min_holder'                          => 'Bu abonelik için bir minimum ve maksimum tutar seçin.',
    'bills_create_repeat_freq_holder'                         => 'Çoğu abonelik aylık olarak tekrarlanır, ancak burada başka bir sıklık ayarlayabilirsiniz.',
    'bills_create_skip_holder'                                => 'Bir abonelik 2 haftada bir tekrarlanıyorsa, her iki haftada bir atlamak için "atla" alanı "1" olarak ayarlanmalıdır.',
