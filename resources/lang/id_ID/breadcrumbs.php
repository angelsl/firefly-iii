...
return [
    ...
    'asset_accounts'         => 'Rekening aset',
    'expense_accounts'       => 'Akun pengeluaran',
    'revenue_accounts'       => 'Rekening pendapatan',
    'liabilities_accounts'   => 'Kewajiban',
    'placeholder'            => '[Placeholder]',

    // mfa
    'profile_mfa'            => 'Autentikasi multi-faktor',
    'mfa_enableMFA'          => 'Aktifkan autentikasi multi-faktor',
    'mfa_backup_codes'       => 'Kode cadangan',
    'mfa_disableMFA'         => 'Nonaktifkan autentikasi multi-faktor',

    // notifications
    'notification_index'     => 'Notifikasi pemilik',

    // exchange rates
    'exchange_rates_index'   => 'Nilai tukar',
    'exchange_rates_rates'   => 'Kurs antara :from dan :to (dan sebaliknya)',
];
