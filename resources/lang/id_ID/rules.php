...
return [
    ...
    'no_such_journal'                             => 'Transaksi ini tidak ada',
    ...
    'journal_not_found'                           => 'Firefly III tidak dapat menemukan transaksi yang diinginkan',
    ...
    'is_already_deposit'                          => 'Transaksi ini sudah menjadi deposit',
    'is_already_transfer'                         => 'Transaksi ini sudah di transfer',
    'no_destination'                              => 'Could not find or create destination account ":name"',
    'is_not_transfer'                             => 'Transaksi ini bukan transfer',
    ...
    'already_linked_to_subscription'              => 'Transaksi sudah tertaut ke langganan ":name"',
    ...
    'cannot_find_subscription'                    => 'Firefly III tidak dapat menemukan langganan ":name"',
    'no_notes_to_move'                            => 'The transaction has no notes to move to the description field',
    'no_tags_to_remove'                           => 'Transaksi tidak ada label untuk dihapus',
    'not_withdrawal'                              => 'Transaksi ini bukan penarikan',
    'not_deposit'                                 => 'Transaksi ini bukan deposit',
    'cannot_find_tag'                             => 'Firefly III tidak dapat menemukan tanda ":tag"',
