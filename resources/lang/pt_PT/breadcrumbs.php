...
return [
    ...
    'bills'                  => 'Subscrições',
    'newBill'                => 'Nova subscrição',
    'edit_bill'              => 'Editar subscrição ":name"',
    'delete_bill'            => 'Apagar subscrição ":name"',
    'reports'                => 'Relatórios',
    ...
    // mfa
    'profile_mfa'            => 'Autenticação multi-fator',
    'mfa_enableMFA'          => 'Ativar autenticação multi-fator',
    'mfa_backup_codes'       => 'Códigos de backup',
    'mfa_disableMFA'         => 'Desativar autenticação multi-fator',

    // notifications
    'notification_index'     => 'Notificações do proprietário',

    // exchange rates
    'exchange_rates_index'   => 'Taxas de câmbio',
    'exchange_rates_rates'   => 'Taxa de câmbio entre :from e :to (e o inverso)',
];
