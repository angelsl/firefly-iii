...
return [
    ...
    'previous_year'                                       => 'Prejšnje leto (:year)',
    'YTD'                                                 => 'YTD',
    ...
    'pref_anonymous'                                      => 'Skriti zneski',
    'pref_anonymous_help'                                 => 'Za zasebnost in anonimnost lahko nastavite Firefly III, da skrije vse zneske. To ne bo skrilo zneskov v poljih za urejanje, preostali pa bodo skriti. To možnost lahko preklopite tudi z ikono "oko" v zgornji vrstici.',
    'pref_anonymous_label'                                => 'Skrij zneske',
    ...
    'test_rate_limited'                                   => 'Prosimo, počakajte trenutek preden poskusite ponovno',
    ...
    'no_new_release_available'                            => 'Ni na voljo posodobitev. Uporabljate najnovejšo različico.',
    ...
    'search_modifier_not_tag_starts'                      => 'Nobena oznaka se ne začne z/s ":value"',
    ...
    'applied_rule_group_selection'                        => '{0} Nobena transakcija v vašem izboru ni bila spremenjena s pravili v skupini pravil ":title".|[1] Ena transakcija v vašem izboru je bila spremenjena s pravili v skupini pravil ":title".|[2,*] :count transakcij v vašem izboru je bilo spremenjenih s pravili v skupini pravil ":title".',
    ...
    'pref_locale_exception'                               => 'Firefly III lahko spremeni samo način prikaza datumov. Vnos datuma bo vedno oblikovan glede na nastavitve brskalnika in ne glede na nastavitve Firefly III. Če je vaš brskalnik nastavljen na »English (US)«, morate datum vedno vnesti v obliki mm/dd/llll. Nobena nastavitev v Firefly III tega ne more spremeniti.',
    ...
    'pref_two_factor_qr_code'                             => 'QR koda',
    ...
    'must_be_owner'                                       => 'Za to dejanje morate biti lastnik sistema',
    ...
    'secure_pw_working'                                   => 'Z izbiro tega polja bo Firefly III poslal prvih pet znakov SHA1 zgoščene vrednosti vašega gesla na <a href="https://haveibeenpwned.com/API/v3#PwnedPasswords">spletno stran Troya Hunta</a>, da preveri, ali je na seznamu. To vam bo preprečilo uporabo nevarnih gesel, kot priporoča najnovejša <a href="https://pages.nist.gov/800-63-3/sp800-63b.html">NIST posebna publikacija</a> na to temo.',
    ...
    'oauth'                                               => 'OAuth',
    'oauth_tokens'                                        => 'Oddaljen dostop in žetoni',
    'oauth_tokens_explain'                                => 'Do te namestitve Firefly III je mogoče dostopati na <code>:link</code>. To velja seveda za vas, pa tudi za spletne aplikacije, agente UI in druge oddaljene programe. Vendar je dostop mogoč samo z uporabo osebnih žetonov za dostop ali OAuth odjemalcev. Oboje je mogoče upravljati na tej strani. Upoštevajte, da Firefly III za razliko od prejšnjih različic skrivnosti odjemalca ne bo več prikazal več kot enkrat.',
    ...
    // budgets:
    'spent_this_period'                                   => 'Porabljeno za ta proračun',
    'spent_this_period_per_day'                           => 'Porabljeno za ta proračun na dan (:days dan(i))',
    'spent_in_budget_limit_outside_period'                => 'Porabljeno za ta proračun, vendar NE v tem obdobju',
    'spent_in_budget_limit_outside_period_per_day'        => 'Porabljeno za ta proračun, vendar NE v tem obdobju na dan (:days dan(i))',
    'left_in_budget_limit_overview'                       => 'Preostalo v tem proračunu',
    'left_in_budget_limit_per_day'                        => 'Preostalo v tem proračunu na dan (:days dan(i))',
    'nothing_left_in_budget'                              => 'Proračun je sedaj prazen',
    ...
    'i_am_owed_amount'                                    => 'Dolgovan mi je znesek',
    ...
    'liability_direction_credit'                          => 'Ta dolg mi dolgujejo',
    ...
    'config_security'                                     => 'Varnostna konfiguracija',
    'config_features'                                     => 'Omogočene funkcije',
    'config_tech'                                         => 'Tehnične funkcije',
    'config_external_connections'                         => 'Občutljive nastavitve zasebnosti (poveže se z internetom)',

    'setting_enable_exchange_rates'                       => 'Omogoči tečajne razlike',
    'setting_enable_exchange_rates_explain'               => 'Firefly III zna za vas samodejno preračunati tečajne razlike.',
    'setting_use_running_balance'                         => 'Uporabi stolpec in podatke »tekočega stanja«',
    'setting_use_running_balance_explain'                 => 'Firefly III lahko izračuna trenutno tekoče stanje za vas in ga prikaže na različnih mestih. Funkcija je še nekoliko eksperimentalna, zato je privzeto onemogočena. Morda boste morali znova zagnati aplikacijo ali ročno izvesti začetni ukaz (glejte dokumentacijo).',
    'setting_enable_external_map'                         => 'Uporabi zunanjo storitev zemljevidov',
    'setting_enable_external_map_explain'                 => 'Firefly III za prikaz lokacij uporablja zunanjo storitev. Je to v redu?',
    'setting_enable_external_rates'                       => 'Prenesi menjalne tečaje s spleta',
    'setting_enable_external_rates_explain'               => 'Firefly III lahko prenese menjalne tečaje za vgrajene valute. Za delovanje je potrebno cron opravilo.',
    'setting_allow_webhooks'                              => 'Dovoli webhooks',
    'setting_allow_webhooks_explain'                      => 'Dovoli Firefly III da proži webhooks?',
    'setting_valid_url_protocols'                         => 'Dovoljeni URL protokoli',
    'setting_valid_url_protocols_explain'                 => 'Firefly III dovoljuje samo URL-je s standardnimi protokoli kot so https in ftp itd. Če ste tehnično podkovani, boste morda želeli dovoliti tudi druge.',
    'setting_enable_batch_processing'                     => 'Omogoči paketno obdelavo',
    'setting_enable_batch_processing_explain'             => 'Paketna obdelava je razmeroma nova funkcija Firefly III, ki omogoča, da se nabor novih transakcij (tj. paket) obdela, ko je predložena zadnja transakcija, in ne med vnosom vsake posamezne transakcije. To naredi uvoz podatkov hitrejši, vendar preskoči pravila vse do konca. Ker gre za eksperimentalno funkcijo, je privzeto onemogočena.',
    ...
    // audit log entries
    'incomplete_ale'                                      => 'V revizijskem dnevniku niso zabeleženi vsi dogodki.',
    ...
    'ale_action_update_foreign_amount'                    => 'Posodobljen tuj znesek',
