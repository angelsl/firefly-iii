...
return [
    ...
    // bill index
    'bills_index_rules'                                       => 'Tu vidite, katera pravila bodo preverila, ali je ta naročnina med zadetki',
    'bills_index_paid_in_period'                              => 'V tem polju je navedeno, kdaj je bila naročnina nazadnje plačana.',
    'bills_index_expected_in_period'                          => 'To polje za vsako naročnino označuje, če in kdaj se pričakuje naslednja naročnina.',

    'subscriptions_index_rules'                               => 'Tukaj vidite, katera pravila bodo preverila, ali je ta naročnina med zadetki',
    'subscriptions_index_paid_in_period'                      => 'V tem polju je navedeno, kdaj je bila naročnina nazadnje plačana.',
    'subscriptions_index_expected_in_period'                  => 'To polje za vsako naročnino označuje, če in kdaj se pričakuje naslednja naročnina.',

    // show bill
    'bills_show_billInfo'                                     => 'Ta tabela prikazuje nekaj splošnih informacij o tej naročnini.',
    'bills_show_billButtons'                                  => 'Uporabite ta gumb za ponovno pregledovanje starih transakcij, da se bodo ujemale s to naročnino.',
    'bills_show_billChart'                                    => 'Ta grafikon prikazuje transakcije, povezane s to naročnino.',
    'subscriptions_show_billInfo'                             => 'Ta tabela prikazuje nekaj splošnih informacij o tej naročnini.',
    'subscriptions_show_billButtons'                          => 'Uporabite ta gumb za ponovno pregledovanje starih transakcij, da se bodo ujemale s to naročnino.',
    'subscriptions_show_billChart'                            => 'Ta grafikon prikazuje transakcije, povezane s to naročnino.',

    // create bill
    'bills_create_intro'                                      => 'Uporabite naročnine za spremljanje zneska denarja, ki vam zapade v vsakem obdobju. Pomislite na stroške, kot so najemnina, zavarovanje ali hipotekarna plačila.',
    'bills_create_name'                                       => 'Uporabite opisno ime, kot je "Najemnina" ali "Zdravstveno zavarovanje".',
    // 'bills_create_match'                                      => 'To match transactions, use terms from those transactions or the expense account involved. All words must match.',
    'bills_create_amount_min_holder'                          => 'Izberite najmanjši in največji znesek za to naročnino.',
    'bills_create_repeat_freq_holder'                         => 'Večina naročnin se ponavlja mesečno, vendar lahko tukaj nastavite drugo pogostost.',
    'bills_create_skip_holder'                                => 'Če se naročnina ponavlja vsaka 2 tedna, je treba polje "preskoči" nastaviti na "1", da preskočite vsak drugi teden.',
