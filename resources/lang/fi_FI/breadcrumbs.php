...
return [
    ...
    'bills'                  => 'Tilaukset',
    'newBill'                => 'Uusi tilaus',
    'edit_bill'              => 'Muokkaa tilausta ":name"',
    'delete_bill'            => 'Poista tilaus ":name"',
    'reports'                => 'Raportit',
    ...
    // mfa
    'profile_mfa'            => 'Monivaiheinen tunnistautuminen',
    'mfa_enableMFA'          => 'Ota monivaiheinen tunnistautuminen käyttöön',
    'mfa_backup_codes'       => 'Palautuskoodit',
    'mfa_disableMFA'         => 'Poista monivaiheinen tunnistautuminen käytöstä',

    // notifications
    'notification_index'     => 'Ylläpitäjän ilmoitukset',

    // exchange rates
    'exchange_rates_index'   => 'Valuuttakurssit',
    'exchange_rates_rates'   => 'Valuuttakurssit :from ja :to välillä (ja toisinpäin)',
];
