...
return [
    ...
    'find_or_create_tag_failed'                   => 'Nem sikerült megtalálni vagy létrehozni ":tag" címkét',
    'tag_already_added'                           => '":tag" címke már hozzá van kapcsolva ehhez a tranzakcióhoz',
    ...
    'no_such_journal'                             => 'Ez a tranzakció nem létezik',
    ...
    'is_already_withdrawal'                       => 'Ez a tranzakció már egy költség',
    'is_already_deposit'                          => 'This transaction is already a deposit',
    'is_already_transfer'                         => 'Ez a tranzakció már egy átvezetés',
    'no_destination'                              => 'Could not find or create destination account ":name"',
    'is_not_transfer'                             => 'Ez a tranzakció nem egy átvezetés',
    ...
    'not_withdrawal'                              => 'Ez a tranzakció nem egy költség',
    'not_deposit'                                 => 'The transaction is not a deposit',
    'cannot_find_tag'                             => 'A Firefly III nem találja ":tag" címkét',
    ...
    'cannot_find_budget'                          => 'A Firefly III nem találja ":name" költségkeretet',
    'cannot_find_category'                        => 'A Firefly III nem találja ":name" kategóriát',
    'cannot_set_budget'                           => 'A Firefly III nem tudja a ":name" költségvetést egy ":type" típusú tranzakcióra beállítani',
    'journal_invalid_amount'                      => 'A Firefly III nem tudja a(z) ":amount" összeget beállítani, mert az nem szám.',
    'cannot_remove_zero_piggy'                    => 'Nem lehet nulla összeget eltávolítani „:name” malacperselyből',
    'cannot_remove_from_piggy'                    => 'Cannot remove :amount from piggy bank ":name"',
    'cannot_add_zero_piggy'                       => 'Nem lehet nulla összeget hozzáadni „:name” malacperselyhez',
