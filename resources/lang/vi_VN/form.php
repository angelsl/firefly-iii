...
return [
    ...
    'bill_areYouSure'             => 'Bạn có chắc chắn muốn xóa đăng ký có tên ":name" không?',
    ...
    'bill_keep_transactions'      => 'Giao dịch duy nhất được kết nối với gói đăng ký này sẽ không bị xóa.|Tất cả :count giao dịch được kết nối với gói đăng ký này sẽ không bị xóa.',
