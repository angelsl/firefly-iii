...
return [
    ...
    'reports_index_inputDateRange'                            => 'Phạm vi ngày được chọn hoàn toàn tùy thuộc vào bạn: từ một ngày đến 10 năm hoặc lâu hơn.',
    ...
    // bill index
    'bills_index_rules'                                       => 'Ở đây, bạn sẽ thấy những quy tắc nào sẽ kiểm tra xem gói đăng ký này có bị ảnh hưởng không',
    'bills_index_paid_in_period'                              => 'Phần này cho biết thời gian thanh toán gói đăng ký lần cuối.',
    'bills_index_expected_in_period'                          => 'Phần này cho biết thời gian đăng ký tiếp theo dự kiến ​​diễn ra đối với mỗi gói đăng ký.',

    'subscriptions_index_rules'                               => 'Ở đây, bạn sẽ thấy những quy tắc nào sẽ ảnh hưởng đến gói đăng ký này.',
    'subscriptions_index_paid_in_period'                      => 'Phần này cho biết thời điểm thanh toán gói đăng ký lần cuối.',
