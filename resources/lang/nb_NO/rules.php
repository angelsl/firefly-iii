...
return [
    ...
    'no_destination'                              => 'Kunne ikke finne eller opprette målkonto ":name"',
    ...
    'not_withdrawal'                              => 'Transaksjonen er ikke et uttak',
    'not_deposit'                                 => 'Transaksjonen er ikke et innskudd',
    ...
    'both_link_piggy'                             => 'Kontoene til denne transaksjonen er begge knyttet til sparegrisen, så ingen handling vil bli utført',
    'already_linked'                              => 'Denne transaksjonen er allerede knyttet til sparegrisen ":name"',
    ...
    'journal_invalid_amount'                      => 'Firefly III kan ikke angi verdien ":amount" fordi det ikke er et gyldig nummer.',
    'cannot_remove_zero_piggy'                    => 'Kan ikke fjerne null beløp fra sparegris ":name"',
    'cannot_remove_from_piggy'                    => 'Kan ikke fjerne :amount fra sparegris ":name"',
    'cannot_add_zero_piggy'                       => 'Kan ikke legge til null beløp i sparegris ":name"',
    'cannot_add_to_piggy'                         => 'Kan ikke legge til :amount til sparegris ":name"',
];
