...
return [
    ...
    'reports_index_inputDateRange'                            => 'Den valgte datoperioden er helt opp til deg: fra en dag til 10 år eller mer.',
    ...
    // bill index
    'bills_index_rules'                                       => 'Her ser du hvilke regler som vil sjekke om dette regningen passer',
    'bills_index_paid_in_period'                              => 'Dette feltet angir når regningen sist ble betalt.',
    'bills_index_expected_in_period'                          => 'Dette feltet angir for hvert abonnement hvis og når neste regning er forventet å tre i kraft.',

    'subscriptions_index_rules'                               => 'Her ser du hvilke regler som vil sjekke om dette abonnementet passer',
    'subscriptions_index_paid_in_period'                      => 'Dette feltet angir når abonnementet sist ble betalt.',
    'subscriptions_index_expected_in_period'                  => 'Dette feltet angir for hvert abonnement hvis og når neste abonnement er forventet å tre i kraft.',

    // show bill
    'bills_show_billInfo'                                     => 'Denne tabellen viser generelle opplysninger om dette abonnementet.',
    'bills_show_billButtons'                                  => 'Bruk denne knappen til å skanne gamle transaksjoner på nytt, slik at de blir riktig koblet opp med dette abonnementet.',
    'bills_show_billChart'                                    => 'Dette diagrammet viser transaksjoner knyttet til dette abonnementet.',
    'subscriptions_show_billInfo'                             => 'Denne tabellen viser generelle opplysninger om dette abonnementet.',
    'subscriptions_show_billButtons'                          => 'Bruk denne knappen til å skanne gamle transaksjoner på nytt, slik at de blir riktig koblet opp med dette abonnementet.',
    'subscriptions_show_billChart'                            => 'Dette diagrammet viser transaksjoner knyttet til dette abonnementet.',

    // create bill
    'bills_create_intro'                                      => 'Bruk abonnement for å spore hvor mange penger du skal betale for hver periode. Tenk på utgifter som leie, forsikring eller nedbetaling av boliglån.',
    'bills_create_name'                                       => 'Bruk et beskrivende navn som "Leie" eller "Helseforsikring".',
    // 'bills_create_match'                                      => 'To match transactions, use terms from those transactions or the expense account involved. All words must match.',
    'bills_create_amount_min_holder'                          => 'Velg et minimum og maksimum beløp for dette abonnementet.',
    'bills_create_repeat_freq_holder'                         => 'De fleste abonnementer gjentas månedlig, men du kan angi en annen frekvens her.',
    'bills_create_skip_holder'                                => 'Hvis et abonnement gjentas hver 2. uke, skal "hopp over"-feltet settes til "1" for å hoppe over annenhver uke.',
