...
return [
    ...
    'bills'                  => 'Підписки',
    'newBill'                => 'Нова підписка',
    'edit_bill'              => 'Редагувати підписку ":name"',
    ...
    // mfa
    'profile_mfa'            => 'Багатофакторна автентифікація',
    'mfa_enableMFA'          => 'Увімкнути багатофакторну автентифікацію',
    'mfa_backup_codes'       => 'Резервні коди',
    'mfa_disableMFA'         => 'Вимкнути багатофакторну автентифікацію',

    // notifications
    'notification_index'     => 'Сповіщення власника',

    // exchange rates
    'exchange_rates_index'   => 'Курси валют',
    'exchange_rates_rates'   => 'Курси валют між :from та :to (і навпаки)',
];
