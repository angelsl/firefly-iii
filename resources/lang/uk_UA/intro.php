...
return [
    ...
    'reports_index_inputDateRange'                            => 'Обраний діапазон дат є цілком таким: від одного дня до 10 років або більше.',
    ...
    // bill index
    'bills_index_rules'                                       => 'Тут ви бачите, які правила будуть перевірені, якщо цю підписку натиснути',
    'bills_index_paid_in_period'                              => 'У цьому полі вказується дата останньої оплати підписки.',
    'bills_index_expected_in_period'                          => 'У цьому полі для кожної підписки вказується, чи очікується наступна підписка і коли саме.',

    'subscriptions_index_rules'                               => 'Тут ви бачите, які правила будуть перевірені, якщо цю підписку натиснути',
    'subscriptions_index_paid_in_period'                      => 'У цьому полі вказується дата останньої оплати підписки.',
    'subscriptions_index_expected_in_period'                  => 'У цьому полі для кожної підписки вказується, чи очікується наступна підписка і коли саме.',

    // show bill
    'bills_show_billInfo'                                     => 'У цій таблиці наведено загальну інформацію про цю підписку.',
    'bills_show_billButtons'                                  => 'Використовуйте цю кнопку для повторного сканування старих транзакцій, щоб вони були зіставлені з цією підпискою.',
    'bills_show_billChart'                                    => 'Ця діаграма показує транзакції, пов\'язані з цією підпискою.',
    'subscriptions_show_billInfo'                             => 'Ця таблиця показує загальну інформацію про цю підписку.',
    'subscriptions_show_billButtons'                          => 'Використовуйте цю кнопку для повторного сканування старих транзакцій, щоб вони були зіставлені з цією підпискою.',
    'subscriptions_show_billChart'                            => 'Ця діаграма показує транзакції, пов\'язані з цією підпискою.',

    // create bill
    'bills_create_intro'                                      => 'Використовуйте підписки, щоб відстежувати суму грошей, яку ви повинні сплачувати кожного періоду. Подумайте про такі витрати, як оренда, страхування або іпотечні платежі.',
    'bills_create_name'                                       => 'Використовуйте описове ім\'я на зразок "Оренда" або "Страхування здоров\'я".',
    // 'bills_create_match'                                      => 'To match transactions, use terms from those transactions or the expense account involved. All words must match.',
    'bills_create_amount_min_holder'                          => 'Виберіть мінімальну і максимальну суму для цієї підписки.',
    'bills_create_repeat_freq_holder'                         => 'Більшість підписок повторюються щомісяця, але тут ви можете встановити іншу частоту.',
    'bills_create_skip_holder'                                => 'Якщо рахунок повторюється кожні 2 тижні, в полі "пропуск" слід ставити значення "1", щоб пропустити кожен інший тиждень.',
