...
return [
    ...
    'check_back'              => 'Firefly III завершився необхідним обслуговуванням. Будь ласка, перевірте повтори спробу через секунду. Якщо ви випадково бачите це повідомлення на демо сайті, просто почекайте кілька хвилин. База даних скидається кожні кілька годин.',
    ...
    'collect_info_more'       => 'Більше про збір інформації про помилку в <a href="https://docs.firefly-iii.org/how-to/general/debug/">FAQ</a>.',
