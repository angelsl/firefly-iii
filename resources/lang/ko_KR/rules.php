...
return [
    ...
    'already_has_source_asset'                    => '이 거래는 이미 ":name"을(를) 출발지 계정으로 가지고 있습니다.',
    'already_has_destination_asset'               => '이 거래는 이미 ":name"을(를) 목적지 자산 계정으로 지정했습니다.',
    'already_has_destination'                     => '이 거래는 이미 ":name"을(를) 목적지 계정으로 지정했습니다.',
    'already_has_source'                          => '이 거래는 이미 ":name"을(를) 출발지 계정으로 가지고 있습니다.',
    ...
    'cannot_find_accounts'                        => 'Firefly III는 출발지 또는 목적지 계정을 찾을 수 없습니다.',
    ...
    'cannot_find_source_transaction_account'      => 'Firefly III는 출발지 거래 계정을 찾을 수 없습니다.',
    'cannot_find_destination_transaction_account' => 'Firefly III는 대상 목적지 계정을 찾을 수 없습니다.',
