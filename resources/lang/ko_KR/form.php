...
return [
    ...
    'asset_destination_account'   => '목적지 계정',
    'include_net_worth'           => '순자산에 포함',
    'asset_source_account'        => '출발지 계정',
    ...
    'run_after_form'              => '이 규칙 적용하기',
    'valid_url_protocols'         => '유효한 URL 프로토콜',
    'allow_webhooks'              => '웹 후크 허용',
    'enable_external_rates'       => '외부 환율 정보 활성화',
    'enable_external_map'         => '외부 지도 정보 활성화',
    'use_running_balance'         => '누계 계산',
    'enable_exchange_rates'       => '환율 활성화',
    'targetamount'                => '목표 금액',
    'target_amount'               => '목표 금액',
    'account_role'                => '계좌 역할',
    ...
    'bill_keep_transactions'      => '이 구독에 연결된 거래내역은 삭제되지 않습니다.|이 구독에 연결된 거래내역 :count건이 유지됩니다.',
    ...
    'withdrawal_destination_id'   => '목적지 계정',
    'deposit_source_id'           => '출발지 계정',
    'expected_on'                 => '예상 일자',
    'paid'                        => '지불됨',
