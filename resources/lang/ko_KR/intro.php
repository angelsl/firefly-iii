...
return [
    ...
    'reports_index_inputDateRange'                            => '선택한 날짜 범위는 하루에서 10년 이상 까지 전적으로 사용자에게 달려 있습니다.',
    ...
    // piggy banks index:
    'piggy-banks_index_saved'                                 => '이 필드에서 저금통별 저축액을 확인할 수 있습니다.',
    ...
    // create piggy
    'piggy-banks_create_name'                                 => '목표가 무엇인가요? 새 소파, 카메라, 비상금인가요?',
