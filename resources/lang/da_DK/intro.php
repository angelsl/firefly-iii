...
return [
    ...
    'reports_index_inputDateRange'                            => 'Det valgte datointerval er helt op til dig: fra en dag til 10 år eller mere.',
    ...
    // bill index
    'bills_index_rules'                                       => 'Her kan du se, hvilke regler der vil kontrollere, om dette abonnement er forfaldet',
    'bills_index_paid_in_period'                              => 'Dette felt angiver, hvornår abonnementet sidst blev betalt.',
    'bills_index_expected_in_period'                          => 'Dette felt angiver for hvert abonnement, hvis og når det næste abonnement forventes at forfalde.',

    'subscriptions_index_rules'                               => 'Her kan du se, hvilke regler der vil kontrollere, om dette abonnement er forfaldet',
    'subscriptions_index_paid_in_period'                      => 'Dette felt angiver, hvornår abonnementet sidst blev betalt.',
    'subscriptions_index_expected_in_period'                  => 'Dette felt angiver for hvert abonnement, hvis og når det næste abonnement forventes at forfalde.',

    // show bill
    'bills_show_billInfo'                                     => 'Denne tabel viser nogle generelle oplysninger om dette abonnement.',
    ...
    'subscriptions_show_billInfo'                             => 'Denne tabel viser nogle generelle oplysninger om dette abonnement.',
    'subscriptions_show_billButtons'                          => 'Brug denne knap til at scanne gamle transaktioner igen, så de vil blive matchet med dette abonnement.',
    'subscriptions_show_billChart'                            => 'Dette diagram viser de transaktioner, der er knyttet til dette abonnement.',

    // create bill
    'bills_create_intro'                                      => 'Brug abonnementer til at spore det beløb du skylder hver periode. Tænk på udgifter som leje, forsikring eller realkreditbetalinger.',
    'bills_create_name'                                       => 'Brug et beskrivende navn som "Leje" eller "Sundhedsforsikring".',
    // 'bills_create_match'                                      => 'To match transactions, use terms from those transactions or the expense account involved. All words must match.',
    'bills_create_amount_min_holder'                          => 'Vælg et minimum og maksimum beløb for dette abonnement.',
    'bills_create_repeat_freq_holder'                         => 'De fleste abonnementer gentages månedligt, men du kan angive en anden frekvens her.',
    'bills_create_skip_holder'                                => 'Hvis et abonnement gentages hver 2. uge, skal "overspring"-feltet indstilles til "1" for at springe over hver anden uge.',
