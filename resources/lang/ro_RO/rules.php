...
return [
    ...
    'no_destination'                              => 'Nu s-a putut găsi sau crea contul destinație ":name"',
    ...
    'already_has_source_asset'                    => 'Această tranzacție are deja ":name" ca și cont sursă de active',
    'already_has_destination_asset'               => 'Această tranzacție are deja ":name" ca și cont destinație de active',
    'already_has_destination'                     => 'Această tranzacție are deja ":name" ca și cont de destinație',
    'already_has_source'                          => 'Această tranzacție are deja ":name" ca și cont sursă',
    ...
    'both_link_piggy'                             => 'Conturile ale acestei tranzacții sunt deja asociate cu pușculița, nu se va face nicio acțiune',
    'already_linked'                              => 'Această tranzacție este deja asociată cu pușculița ":name"',
    ...
    'cannot_remove_zero_piggy'                    => 'Nu se poate elimina suma zero din pușculița ":name"',
    'cannot_remove_from_piggy'                    => 'Nu se poate elimina suma :amount din pușculița ":name"',
    'cannot_add_zero_piggy'                       => 'Nu se poate adăuga suma zero în pușculița ":name"',
    'cannot_add_to_piggy'                         => 'Nu se poate adăuga suma :amount în pușculița ":name"',
];
