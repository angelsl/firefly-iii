...
return [
    ...
    'pref_anonymous_help'                                 => 'Para privacidad y anonimato, puedes hacer que Firefly III oculte todas las cantidades. Esto no ocultará cantidades en las cajas de edición, pero el resto están ocultos. También puedes cambiar esto con el pequeño icono "ojo" en la barra superior.',
    ...
    'test_rate_limited'                                   => 'Por favor espera un momento antes de intentarlo de nuevo.',
    ...
    'anonymous_warning_on'                                => 'Para su privacidad, todas las cantidades se muestran ahora como "cero". ¡Advertencia: los cuadros de texto pueden seguir mostrando las cantidades originales!',
    'anonymous_warning_off'                               => 'Las cantidades serán visibles de nuevo. Por favor, tenga en cuenta sus alrededores.',
    ...
    'webhook_trigger_STORE_BUDGET'                        => 'Después de crear el presupuesto',
    'webhook_trigger_UPDATE_BUDGET'                       => 'Después de actualizar el presupuesto',
    'webhook_trigger_DESTROY_BUDGET'                      => 'Después de borrar el presupuesto',
    'webhook_trigger_STORE_UPDATE_BUDGET_LIMIT'           => 'Después de cambiar el monto presupuestado',
    'webhook_response_TRANSACTIONS'                       => 'Detalles de la transacción',
    'webhook_response_ACCOUNTS'                           => 'Detalles de la cuenta',
    'webhook_response_BUDGET'                             => 'Detalles del presupuesto',
    'webhook_response_RELEVANT'                           => 'Detalles relevantes',
    ...
    'no_new_release_available'                            => 'No hay ninguna nueva versión disponible. Está actualizado.',
    ...
    'search_modifier_not_tag_starts'                      => 'Ninguna etiqueta comienza con ":value"',
    ...
    'rule_run_after_creation'                             => 'Si marca esta casilla, tendrá la oportunidad de ejecutar la regla después de que haya sido creada.',
    'rule_run_after_edit'                                 => 'Si marca esta casilla, tendrá la oportunidad de ejecutar la regla después de que haya sido actualizada.',
    ...
    'rule_trigger_not_tag_contains'                       => 'Ninguna etiqueta contiene ":trigger_value"',
    ...
    'rule_trigger_any_external_url_choice'                => 'Tiene una URL externa (cualquiera)',
    'rule_trigger_any_external_id'                        => 'La transacción tiene un (cualquiera) ID externo',
    'rule_trigger_any_external_id_choice'                 => 'Tiene un ID externo (cualquiera)',
    'rule_trigger_no_external_url_choice'                 => 'Sin URL externa',
    'rule_trigger_no_external_url'                        => 'La transacción no tiene URL externa',
    'rule_trigger_no_external_id_choice'                  => 'Sin ID externa',
    ...
    'pref_locale_exception'                               => 'Firefly III solo puede cambiar cómo se visualizan las fechas. Al introducir una fecha, esta siempre se formateará según la configuración de tu navegador, no la de Firefly III. Si tu navegador está configurado en "Inglés (EE. UU.)", siempre deberás introducir la fecha con el formato mm/dd/aaaa. Ningún ajuste en Firefly III puede cambiar esto.',
    'pref_locale_no_demo'                                 => 'Esta característica no funcionará para el usuario demo.',
    'pref_convert_to_primary'                             => 'Mostrar cantidades en su moneda principal',
    'pref_convert_to_primary_help'                        => 'Esta opción hará que Firefly III intente mostrar su moneda principal en tantos lugares como sea posible, convirtiendo los importes cuando sea necesario. Esto sacrifica precisión en favor de la facilidad de uso, ya que la conversión no siempre es exacta. Por favor, verifique que Firefly III tenga las tasas de cambio necesarias en la página de "tasas de cambio".',
    'pref_convert_primary_help'                           => 'Mostrar cantidades primarias',
    ...
    'pref_two_factor_qr_code'                             => 'Código QR',
    ...
    'temp_administrations_introduction'                   => 'Firefly III pronto tendrá la capacidad de gestionar múltiples administraciones financieras. En este momento, solo tienes una. Puedes establecer el título de esta administración y su moneda principal. Esto reemplaza la configuración anterior donde establecías tu "moneda predeterminada". Este ajuste ahora está vinculado a la administración financiera y puede ser diferente para cada administración.',
    'temp_administrations_introduction_edit'              => 'Actualmente, solo puedes establecer la "moneda principal" de la administración financiera predeterminada. Esto reemplaza la configuración de "moneda predeterminada". Este ajuste ahora está vinculado a la administración financiera y puede ser diferente para cada administración.',
    ...
    'administration_role_mng_piggies'                     => 'Administrar alcancías',
    ...
    'must_be_owner'                                       => 'Debe ser dueño del sistema para hacer esto',
    ...
    'oauth'                                               => 'OAuth',
    'oauth_tokens'                                        => 'Acceso remoto y tokens',
    'oauth_tokens_explain'                                => 'Se puede acceder a esta instalación de Firefly III en <code>:link</code>. Esto se aplica a ti, por supuesto, pero también a aplicaciones web, agentes de IA y otros programas remotos. Sin embargo, este acceso solo es posible mediante el uso de Tokens de Acceso Personal o Clientes OAuth. Ambos se pueden gestionar en esta página. Ten en cuenta que, a diferencia de las versiones anteriores, Firefly III ya no te mostrará el secreto del cliente más de una vez.',
    'regenerate_secret'                                   => 'Regenerar secreto',
    'profile_oauth_clients'                               => 'Clientes de OAuth',
    'explain_pats'                                        => 'Los Tokens de Acceso Personal son claves de larga duración (con un máximo de 1 año) que permiten el acceso directo e ilimitado a tus datos de Firefly III. Herramientas como el Importador de Datos de Firefly III y la integración de Firefly III en Home Assistant utilizan estos tokens para conectarse a Firefly III y hacer lo suyo. Cuando creas un token, este solo es visible una vez. Además, el token es muy largo.',
    ...
    'profile_oauth_clients_explain'                       => 'Un cliente OAuth se puede utilizar para conectar aplicaciones "inteligentes" a Firefly III: aplicaciones que son capaces de redirigirte a tu instancia de Firefly III, obtener tu permiso y devolvertre. El Importador de Datos de Firefly III es una de estas aplicaciones. Los clientes OAuth se pueden generar con o sin un "secreto". Este secreto se utiliza para autenticar al cliente. Dado que no todos los clientes son capaces de almacenar el secreto, tienes la opción de generar un cliente sin él.',
    ...
    // budgets:
    'spent_this_period'                                   => 'Gastado en este presupuesto',
    'spent_this_period_per_day'                           => 'Gastado en este presupuesto por día (:days día(s))',
    'spent_in_budget_limit_outside_period'                => 'Gastado en este presupuesto, pero NO en este periodo',
    'spent_in_budget_limit_outside_period_per_day'        => 'Gastado en este presupuesto, pero NO en este periodo por día (:days día(s))',
    'left_in_budget_limit_overview'                       => 'Disponible en este presupuesto',
    'left_in_budget_limit_per_day'                        => 'Disponible en este presupuesto por día (:days día(s))',
    'nothing_left_in_budget'                              => 'El presupuesto ahora está vacío ',
    ...
    // bills:
    'left_to_pay_active_bills'                            => 'suscripciones activas, esperadass y aún no pagadas',
    ...
    'visit_bills'                                         => 'Ver suscripciones en Firefly III',
    ...
    // accounts:
    'account_locked_currency'                             => 'La moneda de esta cuenta debe permanecer como :name siempre que existan alcancías vinculadas a esta.',
    ...
    'piggy_default_currency'                              => 'Las alcancías solo pueden ahorrar dinero en una moneda única.',
    ...
    'reset_history_confirm'                               => '¿Está seguro que desea restablecer el historial de este banco alcancía? Esto hará que el gráfico coincida con la cantidad del banco alcancía de nuevo.',
    'piggy_history_reset'                                 => 'El historial de la alcancía se ha restablecido',
    ...
    'config_tech'                                         => 'Características relacionadas con la tecnología',
    'config_external_connections'                         => 'Ajustes sensibles a la privacidad (se conecta a internet)',

    'setting_enable_exchange_rates'                       => 'Habilitar tipos de cambio',
    'setting_enable_exchange_rates_explain'               => 'Firefly III tiene la capacidad de calcular los tipos de cambio por usted.',
    'setting_use_running_balance'                         => 'Usar columna de "saldo acumulado" y datos',
    'setting_use_running_balance_explain'                 => 'Firefly III puede calcular el saldo acumulado actual por ti y mostrarlo en varios lugares. Aún es ligeramente experimental, por lo que está desactivado de forma predeterminada. Es posible que debas reiniciar tu contenedor o ejecutar el comando inicial manualmente (consulta la documentación).',
    'setting_enable_external_map'                         => 'Usar servicio de mapas externos',
    'setting_enable_external_map_explain'                 => 'Firefly III utiliza un servicio externo para mostrar ubicaciones. ¿Está bien?',
    'setting_enable_external_rates'                       => 'Descargar tipos de cambio desde la web',
    'setting_enable_external_rates_explain'               => 'Firefly III puede descargar tipos de cambio para las monedas incorporadas. Esto necesita el trabajo de cron para funcionar.',
    'setting_allow_webhooks'                              => 'Permitir webhooks',
    'setting_allow_webhooks_explain'                      => '¿Permitir que Firefly III dispare webhooks?',
    'setting_valid_url_protocols'                         => 'Protocolos de URL permitidos',
    'setting_valid_url_protocols_explain'                 => 'Firefly III solo permite que las URL tengan protocolos estándar como https, ftp, etc. Si tienes conocimientos técnicos, es posible que también quieras permitir otros.',
    'setting_enable_batch_processing'                     => 'Habilitar procesamiento por lotes',
    'setting_enable_batch_processing_explain'             => 'El procesamiento por lotes es una característica relativamente nueva de Firefly III que permite procesar un conjunto de nuevas transacciones (también conocido como lote) cuando se envía la última transacción, y no durante el envío de cada entrada individual. Esto acelera la importación de datos, pero también pospone la aplicación de las reglas hasta el final. Es una función experimental, por lo que está desactivada de forma predeterminada.',
    ...
    'test_notification_channel_name_slack'                => 'Probar Slack',
    'test_notification_channel_name_ntfy'                 => 'Probar Ntfy.sh',
    ...
    'recurring_ndom_skip'                                 => 'Cada :skip(er/o) mes en el :dayOfMonth(er/o) día',
    ...
    // audit log entries
    'incomplete_ale'                                      => 'No todos los eventos se registran como entradas de registro de auditoría.',
    ...
    'ale_action_update_foreign_amount'                    => 'Monto extranjero actualizado',
