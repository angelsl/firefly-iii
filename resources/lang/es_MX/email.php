 ...
 */
    ...
    // bill warning
    'bill_warning_subject_end_date'            => 'Tu factura ":name" debe terminar en :diff días',
    'bill_warning_subject_now_end_date'        => 'Tu factura ":name" está por terminar TODAY',
    'bill_warning_subject_extension_date'      => 'Tu factura ":name" debe ser extendida o cancelada en :diff días',
    'bill_warning_subject_now_extension_date'  => 'Tu factura ":name" debe ser extendida o cancelada HOY',
    'bill_warning_end_date'                    => 'Tu factura **":name"** debe terminar en :date. Este momento pasará alrededor de **:diff días**.',
    'bill_warning_extension_date'              => 'Tu factura **":name"** debe ampliarse o cancelarse el :date. Este momento pasará alrededor de **:diff días**.',
    'bill_warning_end_date_zero'               => 'Tu factura **":name"** debe terminar el :date. ¡Este momento pasará **HOY!**',
    'bill_warning_extension_date_zero'         => 'Tu factura **":name"** debe ser extendida o cancelada el :date. ¡Este momento pasará **HORA!**',
