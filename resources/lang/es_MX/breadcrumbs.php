...
return [
    ...
    'edit_currency'          => 'Editar divisa ":name"',
    ...
    'change_email'           => 'Cambiar tu dirección de correo electrónico',
    'bills'                  => 'Suscripciones',
    'newBill'                => 'Nueva suscripción',
    ...
    'Withdrawal_list'        => 'Gastos',
    'deposit_list'           => 'Ganancias, ingresos y depósitos',
    ...
    // mfa
    'profile_mfa'            => 'Autentificación Multi-factor',
    'mfa_enableMFA'          => 'Habilitar autentificación multi-factor',
    'mfa_backup_codes'       => 'Códigos de respaldo',
    'mfa_disableMFA'         => 'Deshabilitar la autenticación multifactor',

    // notifications
    'notification_index'     => 'Notificaciones del propietario',

    // exchange rates
    'exchange_rates_index'   => 'Tipos de cambio',
    'exchange_rates_rates'   => 'Tipos de cambio entre :from y :to (y al revés)',
];
