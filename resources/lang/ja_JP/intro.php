...
return [
    ...
    'index_accounts-chart'                                    => 'このチャートは、あなたの資産科目の現在の残高を表示しています。設定でここに表示するかどうか選択できます。',
    'index_box_out_holder'                                    => 'この小さなボックスと横にあるボックスは、財務状況の概要を表示しています。',
    'index_help'                                              => 'ページや入力欄についてヘルプが必要なら、このボタンを押して下さい。',
    'index_outro'                                             => 'Firefly IIIの多くのページはこのような小さなツアーから始まります。もし質問やコメントがある場合は、私に連絡して下さい。それでは！',
    ...
    'budgets_index_see_expenses_bar'                          => 'お金を使うと、このバーがゆっくりと満タンになります。',
    ...
    'bills_create_repeat_freq_holder'                         => '多くの購読は月額制ですが、異なる頻度を設定することもできます。',
