...
return [
    ...
    'test_rate_limited'                                   => 'Bitte warten Sie einen Moment, bevor Sie es erneut versuchen',
    ...
    'search_modifier_not_tag_starts'                      => 'Kein Schlagwort beginnt mit ":value"',
    ...
    'pref_locale_exception'                               => 'Firefly III kann lediglich die Darstellung von Datumsangaben ändern. Die Eingabe eines Datums erfolgt stets gemäß den Einstellungen Ihres Browsers und nicht gemäß den Einstellungen von Firefly III. Wenn Ihr Browser auf „Englisch (US)“ eingestellt ist, müssen Sie das Datum immer im Format MM/TT/JJJJ eingeben. Diese Einstellung lässt sich in Firefly III nicht ändern.',
    ...
    'must_be_owner'                                       => 'Sie müssen Eigentümer des Systems sein, um dies tun zu können',
    ...
    'secure_pw_working'                                   => 'Wenn Sie das Kontrollkästchen aktivieren, sendet Firefly III die ersten fünf Zeichen des SHA1-Hashwerts Ihres Passworts an <a href="https://haveibeenpwned.com/API/v3#PwnedPasswords">die Website von Troy Hunt</a>, um zu prüfen, ob es auf der Liste steht. Dadurch wird verhindert, dass Sie unsichere Passwörter verwenden, wie es in der neuesten <a href="https://pages.nist.gov/800-63-3/sp800-63b.html">NIST-Sonderveröffentlichung</a> zu diesem Thema empfohlen wird.',
    ...
    'oauth'                                               => 'OAuth',
    'oauth_tokens'                                        => 'Fernzugriff und Token',
    'oauth_tokens_explain'                                => 'Diese Installation von Firefly III ist unter <code>:link</code> erreichbar. Dies gilt natürlich für Sie, aber auch für Webanwendungen, KI-Agenten und andere Fernzugriff-Programme. Dieser Zugriff ist jedoch nur unter Verwendung von Personal Access Tokens oder OAuth-Clients möglich. Beides kann auf dieser Seite verwaltet werden. Bitte beachten Sie, dass Firefly III Ihnen im Gegensatz zu früheren Versionen den persönlichen Zugangsschlüssel nur ein einziges Mal anzeigt.',
    ...
    // budgets:
    'spent_this_period'                                   => 'Ausgaben im Rahmen dieses Budgets',
    'spent_this_period_per_day'                           => 'Tägliche Ausgaben im Rahmen dieses Budgets (:days Tag(e))',
    'spent_in_budget_limit_outside_period'                => 'Ausgaben im Rahmen dieses Budgets, jedoch NICHT in diesem Zeitraum',
    'spent_in_budget_limit_outside_period_per_day'        => 'Ausgaben für diesen Haushalt, aber NICHT in dieser Periode pro Tag (:days Tag(en))',
    'left_in_budget_limit_overview'                       => 'In diesem Budget verblieben',
    'left_in_budget_limit_per_day'                        => 'In diesem Budget verbleibend pro Tag (:days Tag(e))',
    'nothing_left_in_budget'                              => 'Das Budget ist nun aufgebraucht',
