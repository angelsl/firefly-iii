...
return [
    'verifying_password'              => 'Wachtwoord aan het controleren...',
    'invalid_account_list'            => 'Ongeldig accounttype ":value"',
    'invalid_transaction_type_list'   => 'Ongeldig transactietype',
    'limit_exists'                    => 'Er is al een budget (bedrag) voor dit budget en valuta in de betreffende periode.',
    'invalid_sort_instruction'        => 'De sorteerinstructie is niet geldig voor een object van het type ":object".',
    'invalid_sort_instruction_index'  => 'De sorteerinstructie op index #:index is niet geldig voor een object van het type ":object".',
    'no_sort_instructions'            => 'Er zijn geen sorteerinstructies gedefinieerd voor een object van het type ":object".',
    'webhook_budget_info'             => 'Kan geen budgetinformatie opsturen voor transactie gerelateerde webhooks.',
    'webhook_account_info'            => 'Kan geen rekeninginformatie opsturen voor budget gerelateerde webhooks.',
    'webhook_transaction_info'        => 'Kan geen transactie-informatie opsturen voor budget gerelateerde webhooks.',
    'invalid_account_type'            => 'Een spaarpot kan alleen gekoppeld worden aan betaalrekeningen en passiva',
    'unique_currency_code'            => 'Deze valutacode is al in gebruik',
    ...
    'prohibited'                      => 'Hier mag je niets submitten.',
    'bad_webhook_combination'         => 'Webhook trigger ":trigger" kan niet worden gecombineerd met webhook response ":response".',
    'unknown_webhook_trigger'         => 'Onbekende webhook trigger ":trigger".',
    'only_any_trigger'                => 'Als je de "Any event"-trigger selecteert, kun je geen andere triggers selecteren.',
    ...
    'cannot_add_piggy_amount'         => 'Dit bedrag kan niet worden toegevoegd aan het spaarpotje.',
    ...
    'require_currency_id_code'        => 'Stel "transaction_currency_id" of "transaction_currency_code" in.',
    ...
    'between_date'                    => 'De datum moet liggen tussen de opgegeven begin- en einddatum.',
    ...
    'no_reserved_ip'                  => 'De URL moet naar een geldig IP-adres wijzen.',
    'bad_url_prefix'                  => 'Deze URL is niet geldig.',
    ...
    'convert_to_itself'               => 'Kan wisselkoers niet opslaan voor ":code", omdat beide valuta hetzelfde zijn.',
    'invalid_currency_code'           => 'Valutacode ":code" is ongeldig',
    'scientific_notation'             => 'In veld :attribute kan je de wetenschappelijke notatie niet gebruiken.',
    'numeric_primary'                 => 'Het bedrag in de primaire valuta moet een getal zijn.',
