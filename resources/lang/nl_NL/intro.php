...
return [
    ...
    // bill index
    'bills_index_rules'                                       => 'Hier zie je welke regels een actie hebben voor dit abonnement',
    'bills_index_paid_in_period'                              => 'Dit veld geeft aan wanneer het abonnement het laatst is betaald.',
    'bills_index_expected_in_period'                          => 'Dit veld geeft aan voor elk abonnement of en wanneer je hem weer moet betalen.',

    'subscriptions_index_rules'                               => 'Hier zie je welke regels een actie hebben voor dit abonnement',
    'subscriptions_index_paid_in_period'                      => 'Dit veld geeft aan wanneer het abonnement het laatst is betaald.',
    'subscriptions_index_expected_in_period'                  => 'Dit veld geeft aan voor elk abonnement of en wanneer je hem weer moet betalen.',

    // show bill
    'bills_show_billInfo'                                     => 'Deze tabel bevat wat algemene informatie over dit abonnement.',
    'bills_show_billButtons'                                  => 'Gebruik deze knop om oude transacties opnieuw te scannen, zodat ze aan dit abonnement worden gekoppeld.',
    'bills_show_billChart'                                    => 'Deze grafiek toont de transacties gekoppeld aan dit abonnement.',
    'subscriptions_show_billInfo'                             => 'Deze tabel bevat wat algemene informatie over dit abonnement.',
    'subscriptions_show_billButtons'                          => 'Gebruik deze knop om oude transacties opnieuw te scannen, zodat ze aan dit abonnement worden gekoppeld.',
    'subscriptions_show_billChart'                            => 'Deze grafiek toont de transacties gekoppeld aan dit abonnement.',

    // create bill
    'bills_create_intro'                                      => 'Gebruik abonnementen om de hoeveelheid geld te volgen die je elke periode moet betalen. Denk aan uitgaven zoals huur, verzekering of hypotheekbetalingen.',
    'bills_create_name'                                       => 'Gebruik een beschrijvende naam zoals "huur" of "zorgverzekering".',
    // 'bills_create_match'                                      => 'To match transactions, use terms from those transactions or the expense account involved. All words must match.',
    'bills_create_amount_min_holder'                          => 'Stel een minimum- en maximumbedrag in.',
    'bills_create_repeat_freq_holder'                         => 'De meeste abonnementen herhalen maandelijks, maar dat kan je eventueel veranderen.',
    'bills_create_skip_holder'                                => 'Als een abonnement elke twee weken herhaalt, zet je het "skip"-veld op 1 om elke andere week over te slaan.',
