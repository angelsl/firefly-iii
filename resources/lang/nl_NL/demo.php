...
return [
    ...
    'profile-index'          => 'Hou er rekening mee dat de demo-site elke vier uur reset. Standaard user-agents (curl, Postman, wget) worden geblokkeerd. Je kan ineens zijn uitgelogd. Dit gebeurt automatisch en is geen bug.',
];
