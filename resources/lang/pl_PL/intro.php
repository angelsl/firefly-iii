...
return [
    ...
    // bill index
    'bills_index_rules'                                       => 'Tutaj zobaczysz, które reguły są powiązane z tą subskrypcją',
    'bills_index_paid_in_period'                              => 'To pole wskazuje, kiedy subskrypcja została ostatnio opłacona.',
    'bills_index_expected_in_period'                          => 'To pole wskazuje dla każdej subskrypcji, czy i kiedy oczekuje się następnej opłaty.',

    'subscriptions_index_rules'                               => 'Tutaj zobaczysz, które reguły są powiązane z tą subskrypcją',
    'subscriptions_index_paid_in_period'                      => 'To pole wskazuje, kiedy subskrypcja została ostatnio opłacona.',
    'subscriptions_index_expected_in_period'                  => 'To pole wskazuje dla każdej subskrypcji, czy i kiedy oczekuje się następnej opłaty.',

    // show bill
    'bills_show_billInfo'                                     => 'Ta tabela pokazuje kilka ogólnych informacji o tej subskrypcji.',
    'bills_show_billButtons'                                  => 'Użyj tego przycisku, aby ponownie zeskanować stare transakcje, aby dopasować je do tej subskrypcji.',
    'bills_show_billChart'                                    => 'Ten wykres pokazuje transakcje związane z tą subskrypcją.',
    'subscriptions_show_billInfo'                             => 'Ta tabela pokazuje kilka ogólnych informacji o tej subskrypcji.',
    'subscriptions_show_billButtons'                          => 'Użyj tego przycisku, aby ponownie zeskanować stare transakcje, aby dopasować je do tej subskrypcji.',
    'subscriptions_show_billChart'                            => 'Ten wykres pokazuje transakcje związane z tą subskrypcją.',

    // create bill
    'bills_create_intro'                                      => 'Korzystaj z subskrypcji, aby śledzić kwotę pieniędzy, które trzeba zapłacić regularnie. Pomyśl o takich wydatkach, jak czynsz, ubezpieczenie czy opłaty kredytowe.',
    'bills_create_name'                                       => 'Użyj opisowej nazwy, takiej jak "Czynsz" lub "Ubezpieczenie zdrowotne".',
    // 'bills_create_match'                                      => 'To match transactions, use terms from those transactions or the expense account involved. All words must match.',
    'bills_create_amount_min_holder'                          => 'Wybierz minimalną i maksymalną kwotę dla tej subskrypcji.',
    'bills_create_repeat_freq_holder'                         => 'Większość subskrypcji powtarza się co miesiąc, ale możesz ustawić inną częstotliwość tutaj.',
    'bills_create_skip_holder'                                => 'Jeśli subskrypcja powtarza się co 2 tygodnie, pole "Pomiń" powinno być ustawione na "1", aby pominąć co drugi tydzień.',
