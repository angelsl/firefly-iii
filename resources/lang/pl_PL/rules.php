...
return [
    ...
    'both_link_piggy'                             => 'Oba konta tej transakcji są powiązane ze skarbonką, więc żadna akcja nie zostanie wykonana',
    ...
    'journal_invalid_amount'                      => 'Firefly III nie może ustawić kwoty na ":amount", ponieważ nie jest to prawidłowa liczba.',
    'cannot_remove_zero_piggy'                    => 'Nie można usunąć zerowej kwoty ze skarbonki ":name"',
    'cannot_remove_from_piggy'                    => 'Cannot remove :amount from piggy bank ":name"',
    'cannot_add_zero_piggy'                       => 'Nie można dodać zerowej kwoty do skarbonki ":name"',
