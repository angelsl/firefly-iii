...
return [
    ...
    'oauth_tokens_explain'                                => 'Do tej instalacji Firefly III można się dostać używajc <code>:link</code>. Dotyczy to oczywiście ciebie, ale też i aplikacji webowych, agentów AI i innych programów. Jednakże ten dostęp jest możliwy tylko przy użyciu Osobistych Tokenów Dostępu lub Klienta OAuth. Oboma można zarzdzać na tej stronie. Pamiętaj, że inaczej niż w poprzednich wersjach, Firefly III nie będzie już pokazywał Ci sekretu klienta więcej niż raz.',
