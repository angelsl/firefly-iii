...
return [
    ...
    'test_rate_limited'                                   => 'Veuillez patienter un moment avant de réessayer',
    ...
    'search_modifier_not_tag_starts'                      => 'Aucun tag ne commence par ":value"',
    ...
    'pref_locale_exception'                               => 'Firefly III ne peut modifier que la façon dont les dates sont affichées. La saisie d\'une date sera toujours formatée selon les paramètres de votre navigateur, pas les paramètres de Firefly III. Si votre navigateur est réglé sur "English (US)", vous devez toujours entrer la date formatée en mm/jj/aaaa. Aucun paramètre dans Firefly III ne peut changer cela.',
    ...
    'must_be_owner'                                       => 'Vous devez être le propriétaire du système pour faire cela',
    ...
    'secure_pw_working'                                   => 'En cochant la case, Firefly III enverra les cinq premiers caractères de l\'empreinte SHA1 de votre mot de passe au <a href="https://haveibeenpwned.com/API/v3#PwnedPasswords">site Web de Troy Hunt</a> pour voir si c’il est sur la liste. Cela vous empêchera d\'utiliser des mots de passe dangereux comme cela est recommandé dans la dernière <a href="https://pages.nist.gov/800-63-3/sp800-63b.html">NIST Special Publication</a> à ce sujet.',
    ...
    'oauth'                                               => 'OAuth',
    'oauth_tokens'                                        => 'Accès à distance et jetons',
    'oauth_tokens_explain'                                => 'Cette installation de Firefly III est joignable à l\'adresse <code>:link</code>. Cela vaut pour vous bien sûr, mais aussi pour les applications web, les agents \'AI et d\'autres programmes distants. Cependant, cet accès n\'est possible qu\'avec l\'utilisation de Jetons d\'Accès Personnels ou de Clients OAuth qui peuvent être gérés sur cette page. Attention, contrairement aux versions précédentes, Firefly III ne vous montrera plus le secret du client plus d\'une fois.',
    ...
    // budgets:
    'spent_this_period'                                   => 'Dépensé dans le budget',
    'spent_this_period_per_day'                           => 'Dépensé pour ce budget par jour (:days jour(s))',
    'spent_in_budget_limit_outside_period'                => 'Dépensé pour ce budget, mais PAS pour cette période',
    'spent_in_budget_limit_outside_period_per_day'        => 'Dépensé pour ce budget, mais PAS pour cette période par jour (:days jour(s))',
    'left_in_budget_limit_overview'                       => 'Budget restant',
    'left_in_budget_limit_per_day'                        => 'Reste dans ce budget par jour (:days jour(s))',
    'nothing_left_in_budget'                              => 'Le budget est maintenant vide',
    ...
    'setting_use_running_balance'                         => 'Utiliser la colonne "solde courant" et ses données',
