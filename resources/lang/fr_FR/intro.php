...
return [
    ...
    'index_box_out_holder'                                    => 'Cette petite case et les cases à côté de celle-ci vous donneront un rapide aperçu de votre situation financière.',
    ...
    'reports_index_inputDateRange'                            => 'L\'intervalle de dates sélectionné est entièrement libre : de un jour à 10 ans ou plus.',
    ...
    // bill index
    'bills_index_rules'                                       => 'Ici, vous voyez quelles règles vont s\'appliquer si cet abonnement est payé',
    'bills_index_paid_in_period'                              => 'Ce champ indique quand l’abonnement a été payé pour la dernière fois.',
    'bills_index_expected_in_period'                          => 'Ce champ indique pour chaque abonnement si et quand l’abonnement suivant est attendu.',

    'subscriptions_index_rules'                               => 'Ici, vous voyez quelles règles vont s\'appliquer si cet abonnement est payé',
    'subscriptions_index_paid_in_period'                      => 'Ce champ indique quand l’abonnement a été payé pour la dernière fois.',
    'subscriptions_index_expected_in_period'                  => 'Ce champ indique pour chaque abonnement si et quand l’abonnement suivant est attendu.',

    // show bill
    'bills_show_billInfo'                                     => 'Ce tableau présente des informations générales sur cet abonnement.',
    'bills_show_billButtons'                                  => 'Utilisez ce bouton pour réexaminer les anciennes opérations afin qu\'elles correspondent à cet abonnement.',
    'bills_show_billChart'                                    => 'Ce tableau montre les opérations liées à cet abonnement.',
    'subscriptions_show_billInfo'                             => 'Ce tableau présente des informations générales sur cet abonnement.',
    'subscriptions_show_billButtons'                          => 'Utilisez ce bouton pour réexaminer les anciennes opérations afin qu\'elles correspondent à cet abonnement.',
    'subscriptions_show_billChart'                            => 'Ce tableau montre les opérations liées à cet abonnement.',

    // create bill
    'bills_create_intro'                                      => 'Utilisez les abonnements pour suivre les sommes que vous avez à payer à chaque période. Pensez aux dépenses comme le loyer, l’assurance ou les remboursements d’emprunts.',
    'bills_create_name'                                       => 'Utilisez un nom parlant tel que "Loyer" ou "Assurance maladie".',
    // 'bills_create_match'                                      => 'To match transactions, use terms from those transactions or the expense account involved. All words must match.',
    'bills_create_amount_min_holder'                          => 'Sélectionnez un montant minimum et maximum pour cet abonnement.',
    'bills_create_repeat_freq_holder'                         => 'La plupart des abonnements sont mensuels, mais vous pouvez définir une autre fréquence ici.',
    'bills_create_skip_holder'                                => 'Si un abonnement se répète toutes les 2 semaines, le champ "sauter" doit être réglé sur "1" pour sauter une semaine sur deux.',
