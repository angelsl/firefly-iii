...
return [
    ...
    'profile-index'          => 'Garder à l’esprit que le site de démo se réinitialise toutes les quatre heures. Les agents utilisateurs standard (curl, Postman, wget) sont bloqués. Votre accès peut être révoqué à n\'importe quel moment. Ceci intervient automatiquement, ce n\'est pas un bug.',
];
