...
return [
    ...
    'profile-index'          => 'Tieni presente che il sito demo si reimposta ogni quattro ore. Gli user agent standard (curl, Postman, wget) sono bloccati. Il tuo accesso può essere revocato in qualsiasi momento. Ciò avviene automaticamente e non si tratta di un bug.',
];
