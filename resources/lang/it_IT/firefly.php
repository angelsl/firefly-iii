...
return [
    ...
    'test_rate_limited'                                   => 'Attendi qualche istante prima di riprovare',
    ...
    'search_modifier_not_tag_starts'                      => 'Nessun tag inizia con ":value"',
    ...
    'pref_locale_exception'                               => 'Firefly III può modificare solo le date di visualizzazione. L\'inserimento di una data sarà sempre formattata in base alle impostazioni del browser, non alle impostazioni di Firefly III. Se il tuo browser è impostato su "English (US)" devi sempre inserire la data formattata come mm/gg/aaaa. Nessuna impostazione in Firefly III può cambiarla.',
    ...
    'pref_two_factor_qr_code'                             => 'Codice QR',
    ...
    'must_be_owner'                                       => 'Per fare ciò devi essere il proprietario del sistema',
    ...
    'secure_pw_working'                                   => 'Selezionando la casella, Firefly III invierà i primi cinque caratteri dell\'hash SHA1 della tua password al <a href="https://haveibeenpwned.com/API/v3#PwnedPasswords">sito web di Troy Hunt</a> per verificare se è presente nell\'elenco. Questo ti impedirà di utilizzare password non sicure, come raccomandato nell\'ultima <a href="https://pages.nist.gov/800-63-3/sp800-63b.html">pubblicazione speciale del NIST</a> su questo argomento.',
    'secure_pw_should'                                    => 'Devo spuntare la casella?',
    ...
    'oauth'                                               => 'OAuth',
    'oauth_tokens'                                        => 'Accesso remoto e token',
    'oauth_tokens_explain'                                => 'Questa installazione di Firefly III può essere scaricata dal <code>:link</code>. Questo vale per voi, naturalmente, ma anche per applicazioni web, AI-agenti e altri programmi remoti. Tuttavia, questo accesso è possibile solo con l\'uso di un Token di Accesso Personale o client OAuth. Entrambi possono essere gestiti su questa pagina. Attenzione che, contrariamente alle versioni precedenti, Firefly III non mostrerà più il codice segreto più di una volta.',
    ...
    // budgets:
    'spent_this_period'                                   => 'Speso per questo budget',
    'spent_this_period_per_day'                           => 'Speso per questo budget al giorno (:days giorno(i))',
    'spent_in_budget_limit_outside_period'                => 'Speso per questo budget, ma NON in questo periodo',
    'spent_in_budget_limit_outside_period_per_day'        => 'Speso per questo budget, ma NON in questo periodo al giorno (:days giorno(i))',
    'left_in_budget_limit_overview'                       => 'Rimanente in questo budget',
    'left_in_budget_limit_per_day'                        => 'Rimanente in questo budget al giorno (:days giorno(i))',
    'nothing_left_in_budget'                              => 'Il budget è ora vuoto',
