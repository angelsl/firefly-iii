...
return [
    ...
    // mfa
    'profile_mfa'            => '多因子验证',
    'mfa_enableMFA'          => '启用多因子认证',
    'mfa_backup_codes'       => '备用代码',
    'mfa_disableMFA'         => '禁用多因子认证',

    // notifications
    'notification_index'     => '所有者通知',

    // exchange rates
    'exchange_rates_index'   => '汇率',
    'exchange_rates_rates'   => ':from 和 :to 之间的汇率 (和其它方式)',
];
