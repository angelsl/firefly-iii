...
return [
    ...
    'expenses_by_expense_account'                         => '按目标账户的支出',
    ...
    'pref_anonymous'                                      => '隐藏金额',
    'pref_anonymous_help'                                 => '为了隐私和匿名性，您可以让 Firefly III 隐藏所有金额。这不会隐藏编辑框中的金额，但其余位置会隐藏。您也可以点击顶部栏的小 “眼睛”图标来切换此功能。',
    ...
    'test_rate_limited'                                   => '请过段时间再试',
    'exchange_rate_instructions'                          => '资产账户“@name”仅接受使用 @primary_currency 的交易，若您希望使用 @foreign_currency，请确认 @primary_currency 内的总额是已知的：',
    ...
    'no_new_release_available'                            => '没有更新版本可用。您是最新版本。',
    ...
    'search_modifier_not_tag_starts'                      => '没有标签以“:value”开头',
    ...
    'applied_rule_group_selection'                        => '{0} 规则组“:title”中的规则没有改变任何您选择的交易。|[1] 规则组“:title”中的规则改变了一条您选择的交易。|[2,*] 规则组“:title”中的规则改变了:count条您选择的交易。',
    'rule_run_after_creation'                             => '如果您勾选此项，您将可以在规则创建后运行它。',
    'rule_run_after_edit'                                 => '如果您勾选此项，您将可以在规则更新后运行它。',
    ...
    'rule_trigger_any_external_url_choice'                => '有一个（任意）外部链接',
    'rule_trigger_any_external_id'                        => '交易有一个（任意）外部ID',
    'rule_trigger_any_external_id_choice'                 => '有一个（任意）外部ID',
    'rule_trigger_no_external_url_choice'                 => '没有外部链接',
    'rule_trigger_no_external_url'                        => '交易没有外部URL',
    'rule_trigger_no_external_id_choice'                  => '没有外部ID',
    ...
    'rule_trigger_not_description_contains'               => '描述中不包含":trigger_value"',
    ...
    'pref_convert_to_primary'                             => '以您的主要货币显示金额',
    'pref_convert_to_primary_help'                        => '此选项让 Firefly III 尝试在尽可能多的位置显示您的主要货币，并在必要时换算金额。这会牺牲一定准确性以换取便利，因为换算并非总是完全精确。请确认 Firefly III 的“汇率”页面中已有所需汇率。',
    'pref_convert_primary_help'                           => '以您的主要货币显示金额',
...
',
    ...
    'temp_administrations_introduction_edit'              => '现在，你只能有一个财务管理。你可以设置这个财务管理的名称及其主要货币。 这将取代您先前设置的“默认货币”。 这种设置现在与财务管理挂钩，每个管理可以有不同的设置。',
    ...
    'must_be_owner'                                       => '您必须是系统拥有者才能执行此操作',
    ...
    'oauth'                                               => 'OAuth 授权',
    'oauth_tokens'                                        => '远程访问与令牌',
    'oauth_tokens_explain'                                => '该实例可以从<code>:link</code>访问。这不但适用于您，且适用于网页应用，AI-agent和其他远程访问程序。但仅能通过个人访问令牌或OAuth客户端进行此类访问。两者都能在此页面管理。与旧版本相比，Firefly III 将只展示一次您的客户端密钥 。',
    ...
    'export_data_advanced_expl'                           => '如果您需要更高级或特定类型的导出功能，请阅读帮助以了解如何使用命令 <code>php artisan help firefly-iii:export-data</code> 。',
    ...
    'currencies_switch_default'                           => '您可以在“财务管理”页面为您当前的管理切换主要货币。',
    ...
    // reports:
    'quick_link_needs_accounts'                           => '为了生成报告，您需要至少添加一个资产账户到 Fifrefly III。',
    ...
    'setting_enable_exchange_rates_explain'               => 'Firefly III 能够帮你计算汇率。',
    'setting_use_running_balance'                         => '使用“滚动余额”列及数据',
    'setting_use_running_balance_explain'                 => 'Firefly III 可以为您计算当前滚动余额，并在多处显示。该功能仍带一些实验性质，因此默认处于关闭状态。您可能需要重启容器或手动执行初始命令（请参阅文档）。',
    'setting_enable_external_map'                         => '使用外部地图服务',
    'setting_enable_external_map_explain'                 => 'Firefly III 会使用外部服务来显示位置。允许这么做吗？',
    'setting_enable_external_rates'                       => '从网络下载汇率',
    'setting_enable_external_rates_explain'               => 'Firefly III 可以下载内置货币的汇率。这需要定时任务（cron job）才能生效。',
    'setting_allow_webhooks'                              => '允许 webhooks',
    'setting_allow_webhooks_explain'                      => '允许 Firefly III 触发 webhooks 吗？',
    'setting_valid_url_protocols'                         => '允许的 URL 协议',
    'setting_valid_url_protocols_explain'                 => 'Firefly III 默认仅允许https、ftp等使用标准协议的URL。如果您是一个技术控，您也可以允许其他协议。',
    ...
    'setting_is_demo_site_explain'                        => '若您勾选此选项，此实例将会以展示网站方式运作，会有奇怪的副作用。',
    ...
    'recurring_ndom_skip'                                 => '每:skip个月的第:dayOfMonth个:weekday',
