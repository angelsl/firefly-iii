...
return [
    ...
    'month_to_date'                                       => 'Этот месяц',
    'year_to_date'                                        => 'Этот год',
    'previous_year'                                       => 'Прошлый год (:year)',
    'YTD'                                                 => 'YTD',
    'welcome_back'                                        => 'Что происходит с моими финансами?',
    'main_dashboard_page_title'                           => 'Главная',
    'everything'                                          => 'За всё время',
    'today'                                               => 'сегодня',
    ...
    'go_to_asset_accounts'                                => 'Перейти к основным счетам',
    'go_to_budgets'                                       => 'Перейти к бюджетам',
    ...
    'pref_anonymous'                                      => 'Скрытые суммы',
    'pref_anonymous_help'                                 => 'В целях конфиденциальности и анонимности вы можете скрыть все суммы. Это не скроет суммы в окне редактирования, но значения в других местах будут скрыты. Это можно переключить с помощью значка "глаз" в верхней панели.',
    'pref_anonymous_label'                                => 'Скрыть суммы',
    ...
    'test_rate_limited'                                   => 'Пожалуйста, подождите немного и попробуйте снова',
    ...
    'check_for_updates_permission'                        => 'Firefly III может автоматически проверять наличие обновлений, но для этого требуется ваше разрешение. Перейдите в <a href=":link">настройки</a>, чтобы включить эту функцию.',
    ...
    'update_current_dev_older'                            => 'Вы используете версию ":version" для разработчиков, который старше последней версии :new_version. Пожалуйста, обновитесь!',
    'update_current_dev_newer'                            => 'Вы используете версию ":version" для разработчиков, которая новее последней версии :new_version.',
    ...
    'no_new_release_available'                            => 'Нет новых обновлений. Вы уже используете самую последнюю версию.',
    ...
    'search_modifier_not_tag_starts'                      => 'Нет меток начинающихся с ":value"',
    ...
    'search_modifier_invoice_date_after'                  => '',
    ...
    'search_modifier_not_attachment_notes_contains'       => 'Любые заметки вложений не содержат ":value"',
    ...
    // END
    'general_search_error'                                => 'При поиске произошла ошибка. Пожалуйста, проверьте файлы логов для получения дополнительной информации.',
    'search_box'                                          => 'Поиск',
    ...
    'edit_rule'                                           => 'Изменить правило #:nr ":title"',
    ...
    'rule_run_after_creation'                             => 'Если установить этот флажок, вы сможете выполнить правило после его создания.',
    'rule_run_after_edit'                                 => 'Если установить этот флажок, вы сможете выполнить правило после его обновления.',
    ...
    'rule_trigger_tag_is_choice'                          => 'Любая метка..',
    'rule_trigger_tag_is'                                 => 'Любая метка ":trigger_value"',
    'rule_trigger_tag_contains_choice'                    => 'Любая метка содержит..',
    'rule_trigger_tag_contains'                           => 'Любая метка содержит ":trigger_value"',
    'rule_trigger_not_tag_contains'                       => 'Нет меток содержащих ":trigger_value"',
    ...
    'rule_trigger_tag_is_not'                             => 'Нет метки ":trigger_value"',
    ...
    'rule_trigger_book_date_before_choice'                => 'Дата учёта до..',
    ...
    'rule_trigger_foreign_amount_is_choice'               => 'Сумма в иностранной валюте точно..',
    ...
    'rule_trigger_not_external_id_is'                     => 'Внешний ID не является ":trigger_value"',
    ...
    'rule_trigger_not_book_date_on'                       => 'Дата учёта не ":trigger_value"',
    ...
    'rule_trigger_not_has_no_bill'                        => 'Транзакция содержит (любую) подписку',
    ...
    'rule_action_set_description_choice'                  => 'Установить описание ..',
    ...
    'rule_action_set_destination_account'                 => 'Установить целевой счёт :action_value',
    ...
    'pref_convert_to_primary'                             => 'Показывать суммы в основной валюте',
    ...
    'pref_two_factor_qr_code'                             => 'QR-код',
    ...
    'administration_role_mng_webhooks'                    => 'Управление веб-хуками',
    ...
    'fire_webhooks_checkbox'                              => 'Запускать вебхуки',
    ...
    'primary_currency_button'                             => 'основной',
    ...
    'left_in_budget_limit_overview'                       => 'Осталось в бюджете',
    ...
    'bill_expected_date'                                  => 'Ожидается :date',
    ...
    'cannot_change_amount_reconciled'                     => '',
    ...
    'financial_control'                                   => 'Контроль Финансов',
    ...
    'balance_amount'                                      => 'Расходы по статье бюджета ":budget", оплаченные со счёта ":account" между :start и :end',
    ...
    'add'                                                 => 'Добавить',
    'no_money_for_piggy'                                  => 'У вас нет денег, чтобы положить в эту копилку.',
    ...
    'config_security'                                     => 'Настройки безопасности',
    'config_features'                                     => 'Доступные функции',
    'config_tech'                                         => 'Технические функции',
    'config_external_connections'                         => 'Privacy-sensitive settings (connects to the internet)',

    'setting_enable_exchange_rates'                       => 'Включить курсы обмена валют',
    'setting_enable_exchange_rates_explain'               => 'Firefly III может автоматически рассчитывать курсы валют.',
    ...
    'setting_enable_external_map_explain'                 => 'Firefly III будет использовать внешний сервис для отображения местоположений. Вы согласны?',
    'setting_enable_external_rates'                       => 'Курсы валют',
    'setting_enable_external_rates_explain'               => 'Firefly III может подгружать из интернета курс обмена валют для встроенных валют. Для этого будет включена специальная повторяющиеся задача (cron-job).',
    'setting_allow_webhooks'                              => 'Разрешить веб-хуки',
    'setting_allow_webhooks_explain'                      => 'Разрешить Firefly III использовать веб-хуки?',
    'setting_valid_url_protocols'                         => 'Разрешённые URL протоколы',
    'setting_valid_url_protocols_explain'                 => 'Firefly III допускает URL-ы только со стандартными протоколами, такими как https, ftp и т. д. Если вы энтузиаст, вы можете разблокировать другие.',
    'setting_enable_batch_processing'                     => 'Включить пакетную обработку',
    ...
    'no_accounts_imperative_liabilities'                  => 'Вам необязательно использовать эту функцию, но она может быть полезной, если вы хотите отслеживать такие вещи.',
    ...
    'optional_for_recurring'                              => 'Необязательные сведения о повторении',
    'optional_for_transaction'                            => 'Необязательные сведения о транзакции',
    ...
    'ale_action_log_add'                                  => 'Добавлено :amount в копилку ":name"',
    ...
    'ale_action_clear_tag'                                => 'Метка очищена',
    ...
    'ale_action_add_tag'                                  => 'Добавленная метка',
    'ale_action_update_amount'                            => 'Обновленная сумма',
    'ale_action_update_foreign_amount'                    => 'Обновленная иностранная сумма',
