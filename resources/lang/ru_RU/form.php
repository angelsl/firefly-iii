...
return [
    ...
    'run_after_form'              => 'Выполнить это правило',
    'valid_url_protocols'         => 'Допустимые URL-протоколы',
    'allow_webhooks'              => 'Разрешить веб-хуки',
    'enable_external_rates'       => 'Включить внешние курсы обмена валют',
    'enable_external_map'         => 'Включить внешнюю карту',
    'use_running_balance'         => 'Расчет текущих балансов',
    'enable_exchange_rates'       => 'Включить курсы обмена валют',
    ...
    'enable_batch_processing'     => 'Включить пакетную обработку',
    ...
    'delete_webhook'              => 'Удалить веб-хук ":title"',
    ...
    'webhook_areYouSure'          => 'Вы уверены, что хотите удалить веб-хук с именем ":title?',
    ...
    'not_delete_piggy_banks'      => 'Подключенная к этой группе копилка не будет удалена.|Подключенные к этой группе :count копилок не будут удалены.',
