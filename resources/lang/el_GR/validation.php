...
return [
    ...
    'cannot_add_piggy_amount'         => 'Το ποσό αυτό δεν μπορεί να προστεθεί στον κουμπαρά.',
    ...
    'no_reserved_ip'                  => 'Το URL πρέπει να παραπέμπει σε μια έγκυρη διεύθυνση IP.',
    'bad_url_prefix'                  => 'Αυτό το URL δεν είναι έγκυρο.',
