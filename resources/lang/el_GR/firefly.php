...
return [
    ...
    'test_rate_limited'                                   => 'Παρακαλώ περιμένετε λίγο πριν προσπαθήσετε ξανά',
    ...
    'search_modifier_not_tag_starts'                      => 'Καμία ετικέτα δεν ξεκινά με «:value»',
    ...
    'applied_rule_group_selection'                        => '{0} Καμία συναλλαγή στην επιλογή σας δεν άλλαξε από τους κανόνες της ομάδας κανόνων «:title».|[1] Μια συναλλαγή στην επιλογή σας άλλαξε από τους κανόνες της ομάδας κανόνων «:title».|[2,*] :count συναλλαγές στην επιλογή σας άλλαξαν από τους κανόνες της ομάδας κανόνων «:title».',
    ...
    'must_be_owner'                                       => 'Πρέπει να είστε ο ιδιοκτήτης του συστήματος για να το κάνετε αυτό',
