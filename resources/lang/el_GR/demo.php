...
return [
    ...
    'profile-index'          => 'Λάβετε υπόψιν ότι ο ιστότοπος επίδειξης επαναφέρεται κάθε τέσσερις ώρες. Οι κοινοί user agents (curl, Postman, wget) αποκλείονται. Η πρόσβασή σας μπορεί να ανακληθεί οποιαδήποτε στιγμή. Αυτό συμβαίνει αυτόματα και δεν είναι σφάλμα.',
];
