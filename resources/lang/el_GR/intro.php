...
return [
    ...
    // bill index
    'bills_index_rules'                                       => 'Κανόνας',
    'bills_index_paid_in_period'                              => 'Αυτό το πεδίο υποδεικνύει πότε πληρώθηκε για τελευταία φορά η συνδρομή.',
    'bills_index_expected_in_period'                          => 'Αυτό το πεδίο υποδεικνύει για κάθε συνδρομή, εάν και πότε αναμένεται η επόμενη χρέωση.',

    'subscriptions_index_rules'                               => 'Εδώ βλέπετε ποιοι κανόνες θα τρέξουν όταν εκδοθεί χρέωση για αυτή τη συνδρομή',
    'subscriptions_index_paid_in_period'                      => 'Αυτό το πεδίο υποδεικνύει πότε πληρώθηκε για τελευταία φορά η συνδρομή.',
    'subscriptions_index_expected_in_period'                  => 'Αυτό το πεδίο υποδεικνύει για κάθε συνδρομή, εάν και πότε αναμένεται η επόμενη χρέωση.',

    // show bill
    'bills_show_billInfo'                                     => 'Αυτός ο πίνακας δείχνει κάποιες γενικές πληροφορίες για αυτή τη συνδρομή.',
    'bills_show_billButtons'                                  => 'Χρησιμοποιήστε αυτό το κουμπί για επανέλεγχο παλιών συναλλαγών και αντιπαραβολή με αυτή τη συνδρομή.',
    'bills_show_billChart'                                    => 'Αυτό το γράφημα δείχνει τις συναλλαγές που έχουν συνδεθεί με αυτή τη συνδρομή.',
    'subscriptions_show_billInfo'                             => 'Αυτός ο πίνακας δείχνει κάποιες γενικές πληροφορίες για αυτή τη συνδρομή.',
    'subscriptions_show_billButtons'                          => 'Χρησιμοποιήστε αυτό το κουμπί για επανέλεγχο παλιών συναλλαγών και αντιπαραβολή με αυτή τη συνδρομή.',
    'subscriptions_show_billChart'                            => 'Αυτό το γράφημα δείχνει τις συναλλαγές που έχουν συνδεθεί με αυτή τη συνδρομή.',

    // create bill
    'bills_create_intro'                                      => 'Χρησιμοποιήστε συνδρομές για να παρακολουθήσετε το ποσό των οφειλόμενων χρημάτων κάθε περιόδου. Σκεφθείτε πάγιες δαπάνες όπως ενοίκιο, ασφάλεια ή πληρωμές δόσεων.',
    'bills_create_name'                                       => 'Χρησιμοποιήστε ένα περιγραφικό όνομα όπως "Ενοίκιο" ή "Ασφάλεια υγείας".',
    // 'bills_create_match'                                      => 'To match transactions, use terms from those transactions or the expense account involved. All words must match.',
    'bills_create_amount_min_holder'                          => 'Επιλέξτε ένα ελάχιστο και μέγιστο ποσό για αυτή τη συνδρομή.',
    'bills_create_repeat_freq_holder'                         => 'Οι περισσότερες συνδρομές επαναλαμβάνονται μηνιαίως, εδώ όμως μπορείτε να ορίσετε μια άλλη συχνότητα επανάληψης.',
    'bills_create_skip_holder'                                => 'Εάν μια συνδρομή επαναλαμβάνεται κάθε 2 εβδομάδες, το πεδίο "παράλειψη" πρέπει να οριστεί σε "1" για την παράλειψη κάθε δεύτερης εβδομάδας.',
