...
return [
    ...
    'admin_test_link'                            => 'Ο παρακάτω σύνδεσμος πρέπει να παραπέμπει στην εγκατάσταση του Firefly III σας και να ξεκινά με «http» ή «https». Αν όχι, παρακαλώ ορίστε τη μεταβλητή περιβάλλοντος `APP_URL`: [:link](:link)',
