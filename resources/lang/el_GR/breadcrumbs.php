...
return [
    ...
    'bills'                  => 'Συνδρομές',
    'newBill'                => 'Νέα συνδρομή',
    'edit_bill'              => 'Επεξεργασία συνδρομής «:name»',
    'delete_bill'            => 'Διαγραφή συνδρομής «:name»',
    'reports'                => 'Αναφορές',
    ...
    // mfa
    'profile_mfa'            => 'Έλεγχος ταυτότητας πολλαπλών παραγόντων',
    'mfa_enableMFA'          => 'Ενεργοποίηση ελέγχου ταυτότητας πολλαπλών παραγόντων',
    'mfa_backup_codes'       => 'Εφεδρικοί κωδικοί',
    'mfa_disableMFA'         => 'Απενεργοποίηση ελέγχου ταυτότητας πολλαπλών παραγόντων',

    // notifications
    'notification_index'     => 'Ειδοποιήσεις ιδιοκτήτη',

    // exchange rates
    'exchange_rates_index'   => 'Συναλλαγματικές ισοτιμίες',
    'exchange_rates_rates'   => 'Συναλλαγματικές ισοτιμίες μεταξύ :from και :to (και αντίστροφα)',
];
