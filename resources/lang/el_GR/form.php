...
return [
    ...
    'valid_url_protocols'         => 'Έγκυρα πρωτόκολλα URL',
    'allow_webhooks'              => 'Να επιτρέπονται τα webhooks',
    'enable_external_rates'       => 'Ενεργοποίηση εξωτερικών συναλλαγματικών ισοτιμιών',
    'enable_external_map'         => 'Ενεργοποίηση εξωτερικού χάρτη',
    'use_running_balance'         => 'Υπολογισμός τρεχόντων υπολοίπων',
    'enable_exchange_rates'       => 'Ενεργοποίηση συναλλαγματικών ισοτιμιών',
    ...
    'enable_batch_processing'     => 'Ενεργοποίηση μαζικής επεξεργασίας',
