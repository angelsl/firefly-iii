...
return [
    // index
    'index_intro'                                             => 'ברוכים הבאים לעמוד הראשי של Firefly 3. מומלץ להשקיע כמה דקות בפתיח הזה ולקבל הבנה לאיך Firefly 3 עובד.',
    'index_accounts-chart'                                    => 'הטבלה הזו מראה את היתרה הנוכחית של החשבונות שלך. אתה יכול לבחור מהחשבונות המופיעים בהעדפות שלך.',
    'index_box_out_holder'                                    => 'הקופסה הקטנה הזאת, ואלו שלידה נותנים לך מצג חטוף על המצב הכלכלי שלך.',
    'index_help'                                              => 'אם אי פעם תזדקק לעזרה עם עמוד או טופס כלשהו, לחץ כאן.',
    'index_outro'                                             => 'רוב העמודים של Firefly 3 יתחילו עם הסבר קצר כמו זה. אנא צרו קשר אם יש לכם שאלות נוספות או הערות. תהנו!',
    'index_sidebar-toggle'                                    => 'כדי ליצור תנועה חדשה, חשבון או דברים אחרים, לחץ על התפקיד מתחת לסמל הזה.',
    'index_cash_account'                                      => 'אלו החשבונות שנוצרו עד כה. אתם יכולים להשתמש ב"ארנק" כדי לעקוב אחר הוצאות של מזומן, אך כמובן שזה לא חובה.',

    // transactions
    'transactions_create_basic_info'                          => 'הכניסו מידע בסיסי על התנועה שלכם. מקור, יעד, תאריך ותיאור.',
    'transactions_create_amount_info'                         => 'הכניסו את כמות הכסף לתנועה. במידת הצורך השדות יתעדכנו אוטומטית עבור מידע על מטבעות זרים.',
    'transactions_create_optional_info'                       => 'כל השדות כאן אופציונליים. ככל שתוסיפו יותר מידע, התנועות שלכם יהיו יותר מסודרות בהמשך.',
    'transactions_create_split'                               => 'אם אתם רוצים לפצל תנועה, ניתן להוסיף פיצול באמצעות הכפתור הזה',

    // create account:
    'accounts_create_iban'                                    => 'תתנו לחשבון שלכם מספר IBAN חוקי, זה יסייע במידה ותרצו בעתיד לייבא מידע מבחוץ.',
    ...
    'budgets_index_see_expenses_bar'                          => 'הוצאת כסף ימלא באיטיות את המד הזה.',
    ...
    'budgets_index_outro'                                     => 'כדי ללמוד עוד על התקציב, אנא לחץ על אייקון העזרה בפינה העליונה מימין.',
    ...
    'reports_report_audit_optionsBox'                         => 'השתמשו בתיבות סימון אלה כדי להציג או להסתיר את העמודות שאתם מעוניינים בהן.',

    'reports_report_category_intro'                           => 'דו"ח זה ייתן תובנות לגבי קטגוריה אחת או מספר קטגוריות.',
    'reports_report_category_pieCharts'                       => 'תרשימים אלו יספקו תובנות לגבי הוצאות והכנסות לפי קטגוריה או לפי חשבון.',
    'reports_report_category_incomeAndExpensesChart'          => 'הטבלה הזו מראה את ההוצאות והכנסות לכל קטגוריה.',

    'reports_report_tag_intro'                                => 'דו"ח זה ייתן תובנות לגבי תקציב בודד או מספר תגיות.',
    'reports_report_tag_pieCharts'                            => 'תרשימים אלה יספקו תובנות לגבי הוצאות והכנסות לפי תג, חשבון, קטגוריה או תקציב.',
    'reports_report_tag_incomeAndExpensesChart'               => 'תרשים זה מציג את ההוצאות וההכנסות לפי תג.',

    'reports_report_budget_intro'                             => 'דו"ח זה ייתן לך תובנות לגבי תקציב בודד או מספר תקציבים.',
    ...
    'bills_index_paid_in_period'                              => 'השדה הזה מציג מתי המנוי שילם בפעם האחרונה.',
